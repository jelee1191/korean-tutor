...
export default function ReviewClient({ allExercises }: ReviewClientProps) {
  ...
  const exercises = useMemo(() => {
    const dueIdSet = new Set(dueExerciseIds)
    return allExercises.filter(ex => dueIdSet.has(ex.id))
  }, [dueExerciseIds, allExercises])
